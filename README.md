...
* [flink-issues](https://issues.apache.org/jira/projects/FLINK/issues/FLINK-13408?filter=allopenissues)

## Flink 开发资料
* [flink-china/flink-training-course](https://github.com/flink-china/flink-training-course)
* [5分钟从零构建第一个 Apache Flink 应用](https://ververica.cn/developers/build-from-zero/)
